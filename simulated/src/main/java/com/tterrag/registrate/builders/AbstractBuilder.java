...
public abstract class AbstractBuilder<R, T extends R, P, S extends AbstractBuilder<R, T, P, S>> implements Builder<R, T, P, S> {
    ...
    protected AbstractBuilder(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback,
    ...
    @Override public AbstractRegistrate<?> getOwner() { return owner; }
    @Override public P getParent() { return parent; }
    @Override public String getName() { return name; }
    protected BuilderCallback getCallback() { return callback; }
    @Override public ResourceKey<? extends Registry<R>> getRegistryKey() { return registryKey; }
