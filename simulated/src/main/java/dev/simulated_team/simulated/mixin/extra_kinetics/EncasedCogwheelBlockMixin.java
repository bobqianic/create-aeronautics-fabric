...
public class EncasedCogwheelBlockMixin {
    @WrapOperation(method = "handleEncasing", at = @At(value = "INVOKE", target = "Lcom/zurrtum/create/content/kinetics/base/IRotate;hasShaftTowards(Lnet/minecraft/world/level/LevelReader;Lnet/minecraft/core/BlockPos;Lnet/minecraft/world/level/block/state/BlockState;Lnet/minecraft/core/Direction;)Z"))
