...
public class SimLang {
    ...
    public static CommonLangBuilder builder() {
        return new CommonLangBuilder(Simulated.MOD_ID);
    }
    ...
    public static CommonLangBuilder getPrefixedUnit(String unit, double value, final String format, final int offset) {
    ...
    public static void registrateLang(final RegistrateLangProvider provider) {
        ...
        provider.add(Simulated.MOD_ID + ".keyinfo.rotate_mode", "Physics Staff Rotate Mode");
