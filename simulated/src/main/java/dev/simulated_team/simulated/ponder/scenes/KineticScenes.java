...
public class KineticScenes {
    ...
    public static void portableEngine(final SceneBuilder builder, final SceneBuildingUtil util) {
        ...
        scene.idle(10);
        overlay.showControls(textPos, Pointing.DOWN, 30).withItem(AllItems.BLAZE_CAKE.getDefaultInstance());
        world.modifyBlockEntity(enginePos, PortableEngineBlockEntity.class, be -> {
            be.setCurrentBurnTime(SimItemService.INSTANCE.getBurnTime(AllItems.BLAZE_CAKE.getDefaultInstance()));
    ...
    public static void steeringWheelIntro(final SceneBuilder builder, final SceneBuildingUtil util) {
        ...
        overlay.showText(80)
                .text("Sneaking while turning the wheel snaps to 45鎺?intervals")
                .placeNearTarget()
